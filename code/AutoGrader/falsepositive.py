...
class Ui_FalsePositiveWindow(object):
    def setupUi(self, FalsePositiveWindow):
        ...
        self.FalsePositiveLabel.setGeometry(QtCore.QRect(30, 170, 201, 51))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, FalsePositiveWindow):
        ...
        self.regulatoryLabel_2.setText(_translate("FalsePositiveWindow", "Regulatory:"))
        self.guidingLabel_2.setText(_translate("FalsePositiveWindow", "Guiding:"))
        self.warningLabel_2.setText(_translate("FalsePositiveWindow", "Warning:"))
        self.constructionLabel_2.setText(_translate("FalsePositiveWindow", "Construction:"))
        self.otherLabel_2.setText(_translate("FalsePositiveWindow", "Other:"))
        self.signCategoriesLabel_2.setText(_translate("FalsePositiveWindow", "Sign Categories:"))
