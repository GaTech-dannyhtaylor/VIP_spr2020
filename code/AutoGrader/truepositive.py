...
class Ui_TruePositiveWindow(object):
    def setupUi(self, TruePositiveWindow):
        ...
        self.TruePositiveLabel.setGeometry(QtCore.QRect(30, 170, 201, 51))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(16)
    ...
    def retranslateUi(self, TruePositiveWindow):
        ...
        self.signCategoriesLabel_2.setText(_translate("TruePositiveWindow", "Sign Categories:"))
        self.regulatoryLabel_2.setText(_translate("TruePositiveWindow", "Regulatory:"))
        self.guidingLabel_2.setText(_translate("TruePositiveWindow", "Guiding:"))
        self.warningLabel_2.setText(_translate("TruePositiveWindow", "Warning:"))
        self.constructionLabel_2.setText(_translate("TruePositiveWindow", "Construction:"))
        self.otherLabel_2.setText(_translate("TruePositiveWindow", "Other:"))
